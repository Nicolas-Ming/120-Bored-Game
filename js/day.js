...
day.prototype =  {
	...
	cactusboi: function(){  //-=-= following is written by warner =-=-
      console.log('cactusboi');
      //hat.sendToBack();						// move to back of display list
      game.add.tween(hat).to({ x: 800, y: 260}, 2000, Phaser.Easing.Default, true);
      game.add.tween(hat).to({angle: -360}, 2000, Phaser.Easing.Cubic.In, true);

      //cactusnoface.sendToBack();				// move to back of display list
      game.add.tween(cactusnoface).to({ x: 760, y: 340}, 2000, Phaser.Easing.Default, true);
      game.add.tween(cactusnoface).to({angle: 360}, 2000, Phaser.Easing.Cubic.In, true);

      //jacket.sendToBack();				// move to back of display list
      game.add.tween(jacket).to({ x: 825, y: 420}, 2000, Phaser.Easing.Default, true);
      game.add.tween(jacket).to({angle: -360}, 2000, Phaser.Easing.Cubic.In, true);

      game.add.tween(lefthand).to({ x: 765, y: 500}, 2000, Phaser.Easing.Bounce.out, true);
      game.add.tween(lefthand).to({angle: 360}, 2000, Phaser.Easing.Cubic.In, true);

      //righthand code made after minimal refactoring, hence difference in appearance
      game.add.tween(righthand).to({ x: 875, y: 355}, 2000, Phaser.Easing.Bounce.out, true);
      game.add.tween(righthand).to({angle: -360}, 2000, Phaser.Easing.Cubic.In, true);
      ...
      game.time.events.add(2000, function() {
        ...
        cactusboi.scale.setTo(0.4);
				//game.add.tween(cactusboi).to({angle: -360}, 2000, Phaser.Easing.Cubic.In, true);
				game.add.tween(cactusboi).to({ x: -500, y: 250}, 2000, Phaser.Easing.Bounce.out, true);
